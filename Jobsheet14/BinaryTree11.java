...
public class BinaryTree11 {
    ...
    void traversalPreOrder(Node11 node) {
        if (node != null) {
    ...
    void traversalInOrder(Node11 node) {
        if (node != null) {
    ...
    void traversalPostOrder(Node11 node) {
        if (node != null) {
    ...
    void delete(double ipk) {
        if(isEmpty()) {
            System.out.println("Binary Tree Kossong");
            return;
        }
        ...
        if (current == null) {
            ...
            //jika tida ada anak (leaf), maka node dihapus
    ...
    void addRekursif(Mahasiswa11 data) {
        root = addRekursif(root, data);
    }

    Node11 addRekursif(Node11 current, Mahasiswa11 data) {
        if (current == null) {
